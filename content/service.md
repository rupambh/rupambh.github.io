---
title: "Professional Service & Peer Review"
date: 2026-08-03
draft: false
hidemeta: true
---
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(170px, 1fr)); gap: 12px; margin: 20px 0 25px 0;">
  ...
  <div style="background: var(--entry); border: 1px solid var(--border); border-radius: var(--radius); padding: 14px; text-align: center;">
    <div style="font-size: 1.8em; font-weight: bold; color: var(--accent-teal); line-height: 1.2;">4</div>
    <div style="font-size: 0.85em; color: var(--secondary); margin-top: 4px; font-weight: 600;">Departmental Committees</div>
  </div>
  <div style="background: var(--entry); border: 1px solid var(--border); border-radius: var(--radius); padding: 14px; text-align: center;">
    <div style="font-size: 1.8em; font-weight: bold; color: var(--accent-teal); line-height: 1.2;">3</div>
    <div style="font-size: 0.85em; color: var(--secondary); margin-top: 4px; font-weight: 600;">Conference Roles</div>
  </div>
</div>
...
<div class="filter-container" style="margin-bottom: 25px; padding: 18px; border: 1px solid var(--border); border-radius: var(--radius); background: var(--entry);">
  <input type="text" id="searchJournalInput" placeholder="🔍 Search by journal, publisher, methodology, model, keyword, or year..." style="width: 100%; padding: 10px 14px; border: 1px solid var(--border); border-radius: var(--radius); background: var(--theme); color: var(--primary); font-size: 0.95em; box-sizing: border-box; margin-bottom: 15px;">
...
<ul id="masterJournalList" style="list-style: none; padding-left: 0; margin-top: 15px; margin-bottom: 45px;">
  ...
  <li class="journal-entry" data-domain="interdisciplinary" data-search="discover social science and health springer nature spatial temporal population factors testing rates toronto 2026" style="margin-bottom: 20px; padding-bottom: 16px; border-bottom: 1px solid var(--border);">
    ...
    <div style="font-size: 0.9em; color: var(--primary); line-height: 1.45;">
      <em>Topics & Methodology Refereed:</em> Multi-round evaluation of spatio-temporal demographic modeling analyzing the relationship between marginalization indices and urban pandemic testing coverage in Toronto.
    </div>
    <div style="margin-top: 6px;">
      <a href="https://link.springer.com/journal/44155" target="_blank" style="font-size: 0.84em; font-weight: bold; margin-right: 14px;">📖 Journal Profile ↗</a>
      <a href="https://www.webofscience.com/wos/author/record/ISS-5028-2023" target="_blank" style="font-size: 0.84em; font-weight: bold;">✅ Web of Science Certified</a>
    </div>
  </li>
  ...
  <li class="journal-entry" data-domain="interdisciplinary" data-search="international journal of computational intelligence systems ijcis atlantis press springer nature federated adaptive epidemiological learning fael ai framework 2025" style="margin-bottom: 20px; padding-bottom: 16px; border-bottom: 1px solid var(--border);">
    ...
    <div style="font-size: 0.88em; color: var(--secondary); margin: 4px 0;">
      🏛️ <strong>Publisher:</strong> Atlantis Press / Springer Nature &nbsp;•&nbsp; 🔬 <strong>Domain:</strong> Interdisciplinary & Economics
    </div>
    <div style="font-size: 0.9em; color: var(--primary); line-height: 1.45;">
      <em>Topics & Methodology Refereed:</em> Federated Adaptive Epidemiological Learning (FAEL), distributed privacy-preserving machine learning frameworks for real-time epidemic forecasting across multi-site surveillance centers.
    </div>
    <div style="margin-top: 6px;">
      <a href="https://link.springer.com/journal/44196" target="_blank" style="font-size: 0.84em; font-weight: bold; margin-right: 14px;">📖 Journal Profile ↗</a>
      <a href="https://www.webofscience.com/wos/author/record/ISS-5028-2023" target="_blank" style="font-size: 0.84em; font-weight: bold;">✅ Web of Science Certified</a>
    </div>
  </li>
  ...
  <li class="journal-entry" data-domain="interdisciplinary" data-search="frontiers in psychology financial well-being social innovation food security sociodemographic factors physical activity 2021" style="margin-bottom: 20px; padding-bottom: 16px; border-bottom: 1px solid var(--border);">
    ...
    <div style="font-size: 0.88em; color: var(--secondary); margin: 4px 0;">
      🏛️ <strong>Publisher:</strong> Frontiers Media &nbsp;•&nbsp; 🔬 <strong>Domain:</strong> Interdisciplinary & Economics
    </div>
    <div style="font-size: 0.9em; color: var(--primary); line-height: 1.45;">
      <em>Topics & Methodology Refereed:</em> Quantitative behavioral models across three studies: (1) Psychometric and econometric modeling of investor financial well-being; (2) Quantitative assessment of social innovation programs for poverty alleviation; (3) Structural equation modeling of sociodemographic and built-environment determinants of physical activity.
    </div>
    <div style="margin-top: 6px;">
      <a href="https://www.frontiersin.org/journals/psychology" target="_blank" style="font-size: 0.84em; font-weight: bold; margin-right: 14px;">📖 Journal Profile ↗</a>
      <a href="https://www.webofscience.com/wos/author/record/ISS-5028-2023" target="_blank" style="font-size: 0.84em; font-weight: bold;">✅ Web of Science Certified</a>
    </div>
  </li>
...
## 🏛️ Institutional Governance & Conference Leadership

<p style="color: var(--secondary); margin-top: -8px; margin-bottom: 20px; font-size: 0.95em;">
...
(function() {
  function initJournalFilters() {
    ...
    var searchInput = document.getElementById('searchJournalInput');
    ...
    function update() {
      ...
      items.forEach(function(el) {
        ...
        var matchDomain = (state.domain === 'all' || d === state.domain);
    ...
    document.querySelectorAll('.filter-btn').forEach(function(btn) {
      btn.addEventListener('click', function(e) {
        e.preventDefault();
        var val = this.getAttribute('data-domain');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initJournalFilters);
  } else {
    initJournalFilters();
  }
})();
